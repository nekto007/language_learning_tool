...
- [x] Добавить в CLAUDE.md все новые паттерны открытые в ходе аудита
- [x] Обновить описания изменённых key patterns
- [x] Проверить что CLAUDE.md не содержит устаревших ссылок на удалённый код
- [x] run pytest -m smoke -x (финальная верификация)
