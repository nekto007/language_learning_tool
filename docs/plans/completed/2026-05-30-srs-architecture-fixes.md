...
- [x] Update `CLAUDE.md` Key Patterns section:
...
- [x] Move `docs/audit/srs-audit-2026-05-29.md` to `docs/audit/completed/` (or annotate inline) indicating which findings landed in which task [skipped - file does not exist; audit was part of 2026-05-23-audit-findings.md]
