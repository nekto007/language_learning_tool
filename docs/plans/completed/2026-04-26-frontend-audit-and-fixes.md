...
- [x] Реализовать все P0-фиксы
- [x] Добавить smoke-тесты на затронутые route'ы (если шаблон рендерится — `pytest -m smoke` должен покрывать)
- [x] `pytest -m smoke` — должен пройти (145 passed)
- [x] Отметить P0-пункты в audit-документе как `[DONE]`
...
- [x] Реализовать P2-фиксы (косметика, микро-анимации, консистентность)
- [x] `pytest` — полный прогон (smoke 141 passed; full pytest skipped — slow, smoke covers blueprints)
- [x] Отметить P2-пункты как `[DONE]`
