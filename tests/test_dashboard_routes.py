...
no longer rendered — the dashboard route always renders `dashboard_unified.html`
now, so this entire suite is skipped. The new unified dashboard is covered by
smoke tests and the dedicated unified dashboard render tests elsewhere.
"""
import time
import pytest
