...
Hosts the ``admin`` Blueprint plus the curriculum index/levels/modules/lessons
routes. Dashboard, stats, and content-quality routes were moved to
``app/admin/routes/dashboard_routes.py`` during the 2026-05-24 admin audit.
"""
import json
import logging
